...
-(void)updateData{
    ...
    NSString* where1 = [NSString stringWithFormat:@"where %@=%@",@"name",bg_sqlValue(@"深市")];
    [_shenStock bg_updateWhere:where1];
    //更新沪市数据
    _huData = [NSNumber numberWithFloat:(float)(rand()%200) + 3013.56];
    _huStock.stockData = _huData;
    NSString* where2 = [NSString stringWithFormat:@"where %@=%@",(@"name"),bg_sqlValue(@"沪市")];
    ...
    NSString* where3 = [NSString stringWithFormat:@"where %@=%@",(@"name"),bg_sqlValue(@"创业版")];
